...
Due to GitHub API token permissions, these issues need to be created manually. Visit https://github.com/clawd-machine/lnmarkets-bot/issues/new for each issue below.

---

## Issue 1: Add State Persistence Logging
...
If you have write access to issues via another method, you can use this data programmatically. Otherwise, copy-paste each issue manually from above.
